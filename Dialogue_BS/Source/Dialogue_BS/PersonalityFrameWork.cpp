...
FString UPersonalityFrameWork::GetPersonalityType(int type)
{
	return FString((behaviour->getPersonalityName(type)).c_str());
}

float UPersonalityFrameWork::GetPersonalityValue(int type)
{
